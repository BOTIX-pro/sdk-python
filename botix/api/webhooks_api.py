...
class WebhooksApi:
    ...
    def webhooks_create(
        self,
        webhooks_create_request: WebhooksCreateRequest,
        ...
        :param webhooks_create_request: (required)
        :type webhooks_create_request: WebhooksCreateRequest
    ...
    def webhooks_create_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WebhooksCreate201Response]:
        """Создать подписку
    ...
    def _webhooks_create_serialize(
        ...
        if webhooks_create_request is not None:
            _body_params = webhooks_create_request
    ...
    def webhooks_test(
        ...
        _param = self._webhooks_test_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def webhooks_test_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WebhooksTest200Response]:
        """Тестовая отправка
    ...
    @validate_call
    def webhooks_test_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
