...
class MeResponseData(BaseModel):
    ...
    plan_key: Optional[StrictStr] = None
    limits: Optional[MeResponseDataLimits] = None
    rate_limit: Optional[MeResponseDataRateLimit] = None
    __properties: ClassVar[List[str]] = ["project_id", "api_key_id", "scopes", "plan_key", "limits", "rate_limit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "limits": MeResponseDataLimits.from_dict(obj["limits"]) if obj.get("limits") is not None else None,
            "rate_limit": MeResponseDataRateLimit.from_dict(obj["rate_limit"]) if obj.get("rate_limit") is not None else None
        })
        return _obj
