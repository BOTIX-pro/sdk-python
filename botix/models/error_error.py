...
class ErrorError(BaseModel):
    ...
    def code_validate_enum(cls, value):
        ...
        if value not in set(['MISSING_API_KEY', 'INVALID_API_KEY', 'KEY_REVOKED', 'IP_BANNED', 'INSUFFICIENT_SCOPE', 'API_NOT_AVAILABLE_ON_PLAN', 'TRIAL_READ_ONLY', 'RATE_LIMIT_EXCEEDED', 'VALIDATION_ERROR', 'INVALID_JSON', 'INVALID_CURSOR', 'NOT_FOUND', 'NO_CHANNEL_AVAILABLE', 'CHANNEL_NOT_SUPPORTED_YET', 'CHANNEL_NOT_ALLOWED', 'CHANNEL_NOT_CONNECTED', 'CONTACT_NOT_REACHABLE', 'CONTACT_NOT_FOUND', 'CONTACT_BUSY', 'SCENARIO_NOT_FOUND', 'SCENARIO_INACTIVE', 'NO_START_BLOCK', 'DELIVERY_FAILED']):
            raise ValueError("must be one of enum values ('MISSING_API_KEY', 'INVALID_API_KEY', 'KEY_REVOKED', 'IP_BANNED', 'INSUFFICIENT_SCOPE', 'API_NOT_AVAILABLE_ON_PLAN', 'TRIAL_READ_ONLY', 'RATE_LIMIT_EXCEEDED', 'VALIDATION_ERROR', 'INVALID_JSON', 'INVALID_CURSOR', 'NOT_FOUND', 'NO_CHANNEL_AVAILABLE', 'CHANNEL_NOT_SUPPORTED_YET', 'CHANNEL_NOT_ALLOWED', 'CHANNEL_NOT_CONNECTED', 'CONTACT_NOT_REACHABLE', 'CONTACT_NOT_FOUND', 'CONTACT_BUSY', 'SCENARIO_NOT_FOUND', 'SCENARIO_INACTIVE', 'NO_START_BLOCK', 'DELIVERY_FAILED')")
        return value
