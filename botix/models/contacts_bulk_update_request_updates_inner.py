...
class ContactsBulkUpdateRequestUpdatesInner(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContactsBulkUpdateRequestUpdatesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContactsBulkUpdateRequestUpdatesInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "fields": ContactWritable.from_dict(obj["fields"]) if obj.get("fields") is not None else None
        })
        return _obj
