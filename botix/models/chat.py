...
class Chat(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "project_id", "contact_id", "channel", "scenario_id", "status", "messages_count", "last_message_at", "created_at", "updated_at"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['active', 'paused', 'completed', 'operator']):
            raise ValueError("must be one of enum values ('active', 'paused', 'completed', 'operator')")
        return value
