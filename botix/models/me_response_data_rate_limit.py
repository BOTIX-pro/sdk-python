...
class MeResponseDataRateLimit(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["limit", "remaining", "reset_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MeResponseDataRateLimit from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MeResponseDataRateLimit from a dict"""
        if obj is None:
            return None
